...
namespace BUS
{
    public class NguoiDungBUS
    {
        ...
        public static bool ThemNguoiDung(NguoiDungDTO nd)
        {
            ...
            string matkhauMH = NguoiDungBUS.GetMd5Hash(md5Hash, nd.Matkhau);
            nd.Matkhau = matkhauMH;
        ...
        public static bool XoaNguoiDung(string ma)
        {
            return NguoiDungDAO.XoaNguoiDung(ma);
        }
